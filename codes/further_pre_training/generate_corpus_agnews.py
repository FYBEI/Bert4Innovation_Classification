...
test_data = pd.read_csv(os.path.join(dir, "test.csv"), header=None, sep=",").values
train_data = pd.read_csv(os.path.join(dir, "train.csv"), header=None, sep=",").values

test = []
train = []
with open("corpus/AGnews_corpus_test.txt", "w", encoding="utf-8") as f_test:
    with open("corpus/AGnews_corpus_train.txt", "w", encoding="utf-8") as f_train:
        with open("corpus/AGnews_corpus.txt", "w", encoding="utf-8") as f:
